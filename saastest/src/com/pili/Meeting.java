...
public class Meeting {
	String ak = "PbdNvcSv-OfX-H4yFaPQ8psXyOAEjKCerJ6SNUJS";
	String sk = "d0Kub97tYFKHDukFEgq05-lWIf1ojX0hZBU51hma";
    private Credentials mCredentials = new Credentials(ak, sk);
