...
import com.pili.Meeting.CreateArgs;
import com.pili.Meeting.Room;
import com.pili.Meeting.RoomName;
...
public final class API {
    ...
    // Create a new stream
    public static Stream createStream(com.pili.Credentials mCredentials, String hubName, String title, String publishKey,
...
//        System.out.println("createStream:" + API_BASE_URL);
        ...
        try {
            ...
            String macToken = mCredentials.signRequest(url, "POST", body, contentType);
        ...
        if (response.isSuccessful()) {
            ...
            try {
                ...
                return new Stream(jsonObj, mCredentials);
            } catch (IOException e) {
                e.printStackTrace();
                throw new PiliException(e);
            }
    ...
    // Get an exist stream
    public static Stream getStream(com.pili.Credentials mCredentials, String streamId) throws PiliException {
        if (streamId == null) {
        ...
        try {
            ...
            String macToken = mCredentials.signRequest(url, "GET", null, null);
            Request request = new Request.Builder()
                    .url(url)
                    .get()
                    .header("User-Agent", Utils.getUserAgent())
    ...
    // List stream
    public static StreamList listStreams(com.pili.Credentials mCredentials, String hubName, String status,
        ...
        if (response.isSuccessful()) {
            ...
            try {
                JsonObject jsonObj = parser.parse(response.body().string()).getAsJsonObject();
                return new StreamList(jsonObj, mCredentials);
            } catch (IOException e) {
                e.printStackTrace();
                throw new PiliException(e);
            }
    ...
    // get stream status
    public static Status getStreamStatus(com.pili.Credentials mCredentials, String streamId) throws PiliException {
        if (streamId == null) {
            throw new PiliException(MessageConfig.NULL_STREAM_ID_EXCEPTION_MSG);
        }
    ...
    public static Stream updateStream(com.pili.Credentials mCredentials, String streamId, String publishKey,
    ...
    // Delete stream
    public static String deleteStream(com.pili.Credentials mCredentials, String streamId) throws PiliException {
        if (streamId == null) {
            throw new PiliException(MessageConfig.NULL_STREAM_ID_EXCEPTION_MSG);
        }
        ...
        try {
            ...
            String macToken = mCredentials.signRequest(url, "DELETE", null, null);
            Request request = new Request.Builder()
                    .url(url)
                    .delete()
                    .header("User-Agent", Utils.getUserAgent())
    ...
    public static SaveAsResponse saveAs(com.pili.Credentials mCredentials, String streamId, String fileName, String format,
...
//                System.out.println(jsonObj.toString());
    ...
    public static SnapshotResponse snapshot(com.pili.Credentials mCredentials, String streamId, String fileName, String format,
    ...
    public static SegmentList getStreamSegments(com.pili.Credentials mCredentials, String streamId, long startTime, long endTime,
    ...
    public static Map<String, String> hlsPlaybackUrl(com.pili.Credentials mCredentials, Stream stream,
                                                     long startTime, long endTime)
            throws PiliException {
        final SaveAsResponse response = saveAs(mCredentials, stream.getStreamId(),
    ...
    //----------------------------rtc
    public static String createRoom(com.pili.Credentials mCredentials, CreateArgs args) throws PiliException {
    ...
    public static Room getRoom(com.pili.Credentials mCredentials, String room) throws PiliException {
        if (room == null) {
    ...
    public static void deleteRoom(com.pili.Credentials mCredentials, String room) throws PiliException {
        if (room == null) {
            throw new PiliException(MessageConfig.ILLEGAL_ROOM);
        }
        Gson gson = new Gson();
