...
public final class Stream {
    ...
    private com.pili.Credentials mCredentials;
...
//        System.out.println("Stream:" + jsonObj.toString());
    ...
    public Stream(JsonObject jsonObject, com.pili.Credentials mCredentials2) {
        this(jsonObject);
        mCredentials = mCredentials2;
    }
    ...
    public static class StreamList {
        ...
        public StreamList(JsonObject jsonObj, com.pili.Credentials mCredentials) {
            ...
            try {
                ...
                while (it.hasNext()) {
                    JsonObject json = it.next().getAsJsonObject();
                    itemList.add(new Stream(json, mCredentials));
                }
